...
<div class="content-wrapper">
    ...
    <section class="content container-fluid" id="animated-content">
        <div id='write' class='is-mac'>
            ...
            <p>Blog : <a href="#" target="_blank">https://codeyaco.cn</a> </p>
            <p>Email : <a href='#'></a>@@@@</p>
            <p>Telegram : <a href="#" target="_blank">XIANS</a></p>
            <p>Telegram Channel: <a href="https://t.me/halo_dev" target="_blank">Yaco's Channel</a></p>
            <p>QQ : 1522009509</p>
        </div>
    </section>
</div>
